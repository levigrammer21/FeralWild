const CACHE='feralwild-1.0.0';
const FILES=['./','index.html','game.css','app.mjs','engine.mjs','data.mjs','saves.mjs','online.mjs','firebase-config.mjs','icon.svg','ferals-a.png','ferals-b.png'];
